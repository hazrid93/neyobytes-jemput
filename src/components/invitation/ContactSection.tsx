  ...
  return (
    ...
    >
      ...
      >
        <EditableCopy
          as="span"
          value={copy('contact.eyebrow', 'Hubungi Kami')}
          copyKey="contact.eyebrow"
      ...
      >
        <EditableCopy
          as="span"
          value={copy('contact.title', 'Sebarang Pertanyaan')}
          copyKey="contact.title"
          editMode={previewEditMode}
        />
      </motion.h3>
          ...
          >
            <TemplateSectionShell templateId={templateId} padding="20px">
              ...
              >
                ...
                <EditableCopy
                  as="span"
                  value={copy('contact.phone', 'Telefon')}
              ...
              >
                ...
                <EditableCopy
                  as="span"
                  value={copy('contact.whatsapp', 'WhatsApp')}
                  copyKey="contact.whatsapp"
                  editMode={previewEditMode}
                />
              </a>
              </div>
