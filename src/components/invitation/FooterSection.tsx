...
export default function FooterSection({ invitation, templateId, copyOverrides, previewEditMode = false }: FooterSectionProps) {
  ...
  return (
    ...
    >
      ...
      >
        <EditableCopy as="span" value={copy('footer.closing_prefix', 'Dengan hormat,')} copyKey="footer.closing_prefix" editMode={previewEditMode} />
      </motion.p>
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        <EditableCopy as="span" value={copy('footer.closing_family', 'Keluarga Pengantin')} copyKey="footer.closing_family" editMode={previewEditMode} />
      </motion.p>
      ...
      >
        <EditableCopy as="span" value={copy('footer.share_label', 'Kongsi Jemputan')} copyKey="footer.share_label" editMode={previewEditMode} />
      </motion.p>
      ...
      >
        ...
        >
          ...
          <EditableCopy as="span" value={copy('footer.whatsapp', 'WhatsApp')} copyKey="footer.whatsapp" editMode={previewEditMode} />
        </a>
        ...
        >
          ...
          <EditableCopy as="span" value={linkCopied ? copy('footer.copied', 'Disalin!') : copy('footer.copy', 'Salin Pautan')} copyKey={linkCopied ? 'footer.copied' : 'footer.copy'} editMode={previewEditMode} />
        </button>
      </motion.div>
      ...
      >
        ...
        >
          <EditableCopy as="span" value={copy('footer.credit_prefix', 'Dibuat dengan')} copyKey="footer.credit_prefix" editMode={previewEditMode} />{' '}
